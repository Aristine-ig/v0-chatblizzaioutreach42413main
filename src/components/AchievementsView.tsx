...
export default function AchievementsView({ userId, onClose, inline = false }: AchievementsViewProps) {
              ...
              return (
                ...
                >
                  <div className="flex items-start gap-4">
                    <div className={`text-4xl p-3 rounded-xl ${isEarned ? "bg-white shadow-md" : "bg-gray-200"}`}>
                    ...
                    <div className="flex-1">
                      ...
                      <p className={`text-sm mb-2 ${isEarned ? "text-gray-700" : "text-gray-500"}`}>
                    ...
                    <div className="flex items-start gap-4">
                      ...
                      <div className="flex-1">
                        ...
                        <div className="flex items-center justify-between">
                          <span className={`text-xs font-medium ${isEarned ? "text-amber-600" : "text-gray-400"}`}>
