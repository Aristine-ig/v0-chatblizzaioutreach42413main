...
import { supabase, type FoodLog, type UserProfile } from "../lib/supabase"
...
export default function ExportView({ userId, onClose }: ExportViewProps) {
  ...
  return (
    <div className="bg-white rounded-2xl sm:rounded-3xl shadow-2xl w-full max-w-2xl mx-auto max-h-[85vh] overflow-y-auto">
      ...
      <div className="p-6">
        ...
        {loading && <div className="mt-4 text-center text-gray-600">Preparing export...</div>}
      </div>
    </div>
  )
}
